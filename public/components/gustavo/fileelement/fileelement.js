const filePathfileelement = document.currentScript.src.split('/')
const cssNamefileelement = filePathfileelement[filePathfileelement.length - 1].replace('js', 'css')

filePathfileelement.pop()
filePathfileelement.push(cssNamefileelement)

const cssPathfileelement = filePathfileelement.join('/')
