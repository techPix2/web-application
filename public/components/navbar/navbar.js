...
class navbar extends HTMLElement {
    ...
    render() {
        ...
        const companyName = sessionStorage.getItem('NOME_EMPRESA');
        const userType = sessionStorage.getItem('CARGO_FUNCIONARIO');

        let buttonsHTML = ``;

        if (userType === 'Administrador') {
            buttonsHTML += `
            <a href="admin.html" class="navButton">
            ...
            <a href="servidores.html" class="navButton">
            ...
            <a href="dashboardVinicius.html" class="navButton">
        ...
        if(userType === 'Cientista') {
            buttonsHTML += `
        <a href="dashboardGustavo.html" class="navButton">
        ...
        <a href="dashboardFelipe.html" class="navButton">
        ...
        if(userType === 'Analista') {
            buttonsHTML += `
        <a href="dashboardLara.html" class="navButton">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-bar-chart-fill" viewBox="0 0 16 16">
              <path d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1z"/>
            </svg>
            Tempo real
        ...
        <div class="navbar">
            <div class="navInfo">
                <div class="navInfoText">
                    <h2 class="userName">Olá ${userName}</h2>
            ...
            <hr>
            <div class="exitDiv">
                   <a href="" class="navButton sairBtn">
    ...
    `;
        this.shadowRoot.querySelector('.sairBtn').addEventListener('click', (e) => {
            e.preventDefault();
            this.sair();
        });
