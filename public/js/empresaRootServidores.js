...
<div class="inferior-modal">
    <div class="esquerda-inferior-modal">
        <div class="formulario">
            <span class="descricao-modal">Hostname:<span class="obrigatorio">*</span></span>
            <input class="input-modal" type="text" id="ipt_nome">
        </div>
        <div class="formulario">
            <span class="descricao-modal">IP:<span class="obrigatorio">*</span></span>
            <input class="input-modal" type="text" id="ipt_email">
        </div>
        <div class="formulario">
            <span class="descricao-modal">Localização:<span class="obrigatorio">*</span></span>
            <input class="input-modal" type="text" id="ipt_senha">
        </div>
        <div class="formulario">
            <span class="descricao-modal">Id Placa-Mãe:<span class="obrigatorio">*</span></span>
            <input class="input-modal" type="text" id="ipt_email">
        </div>
    </div>
